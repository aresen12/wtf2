...
def index():
    ...
    works = [item.to_dict(only=(
        "id", "team_leader", 'job', 'work_size', 'collaborators', 'is_finished')) for
        item
        in jobs]
    print(works)
    return render_template('index.html', works=works, title='Домашняя страница')
